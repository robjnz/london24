...
<section main>
  ...
  <b-card-group deck
      class="mb-3">
    <b-card bg-variant="dark" text-variant="white" title= "Picturehouses">
  <p class="title-color">
  ...
  <b-card bg-variant="dark" text-variant="white" title= "Showcase Cinemas">
  <p class="title-color">
...
export default {
  head () {
    return {
      titleTemplate: '%s Cinemas',
      meta         : [
        { hid: 'description', name: 'description', content: ' cinemas in east London, Cineworld, Odeon, Picturehouses, Showcase Cinemas and Vue ' }
      ]
    }
  }
}
