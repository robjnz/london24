...
<section main>
  <b-container>
    <b-row>
    <h1 class="title-color">Education</h1>
  <div>
...
export default {
  head () {
    return {
      titleTemplate: '%s Education',
      meta         : [
        { hid: 'description', name: 'description', content: 'Education, local collages in east London and online courses. ' }
      ]
    }
  }
}
