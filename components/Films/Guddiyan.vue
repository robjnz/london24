<template>
<b-card bg-variant="dark" text-variant="white" title= "Guddiyan Patole TBC">
<b-embed type="iframe"
          aspect = "16by9"
          src    = "https://www.youtube.com/embed/XFPo9Br-a_c"
          allowfullscreen
  ></b-embed>
...
import GuddiyanR from '@/components/ReviewMovies/GuddiyanR'
