<template>
<b-card bg-variant="dark" text-variant="white" title= "Cold Pursuit 15">
<b-embed type="iframe"
          aspect = "16by9"
          src    = "https://www.youtube.com/embed/7C2Nad0aMPg"
          allowfullscreen
  ></b-embed>
...
import ColdR from '@/components/ReviewMovies/ColdR'
import ColdF from '@/components/FreeMovies/ColdF'
